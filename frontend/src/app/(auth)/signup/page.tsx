...
import { getGoogleUrl, postRegister } from '@/modules/users/services';
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-md w-full space-y-8 shadow bg-white p-20xs md:p-20md rounded">
                <div>
                    <h2 className="mt-6 text-center text-28xs md:text-28md font-extrabold text-gray-900 flex justify-center">Đăng ký | <img className="h-42xs md:h-48md w-auto" src="/logo.png" alt="Logo" /> GoUni</h2>
                </div>
                <Form
                    name="normal_signup"
