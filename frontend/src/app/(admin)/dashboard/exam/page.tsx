"use client"
import CreateExam from '@/components/dashboard/exam/add/page';
import ExamTable from '@/components/dashboard/exam/table/page';
...
const ExamAdmin = (props: Props) => {
    ...
    const fetch = async (subject_id?: number, chapter_id?: number, page?: number) => {
        ...
        <div className='shadow'>
            <div className='bg-white rounded mr-5xs md:mr-5md mt-5xs md:mt-5md'>
                <div className='flex border-b py-20xs md:py-20md justify-between items-center'>
                    <div className='px-10xs md:px-10md text-24xs md:text-24md font-bold'>Quản lý đề thi</div>
                    <div className='px-10xs md:px-10md'>
                        {
                            subjectId && (<CreateExam exams={exams} setExams={setExams} subjectId={subjectId} chapterId={chapterId} />)
                        }
                    </div>
                </div>
                            ...
                            <div>
                                <div className='mb-12xs md:mb-12md'>
                                    <div className='mt-6xs md:mt-6md flex gap-10xs md:gap-10md'>
                                        ...
                                        {(subjectId || chapterId) && (
                                            <button
                                                className='bg-[#283547] text-white mt-12xs md:mt-12md py-7xs md:py-7md px-10xs md:px-10md'
                                                onClick={handleLoad}
                                            >
                                                Xác nhận
                                            </button>
                                ...
                                <div className='flex-1'>
                                    <ExamTable exams={exams} setExams={setExams} page={current} fetch={fetch} chapterId={chapterId} subjectId={subjectId} />
