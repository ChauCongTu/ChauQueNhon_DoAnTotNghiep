...
const QuestionManagement: React.FC<Props> = ({ questionIds, setQuestionIds, questions, setQuestions, subjectId, max_question, selectedQuestions, setSelectedQuestions }) => {
        ...
        <div>
            <div className='flex items-center gap-10xs md:gap-10md mb-12xs md:mb-12md'>
                <AddQuestionToForm selectedQuestions={selectedQuestions}
                    ...
                    handleRemoveQuestion={handleRemoveQuestion} propSubjectId={subjectId} />
